##使用Github作为第三方依赖包的托管仓库，实现公网的Maven私服Nexus
  ...
  3）将第三方依赖包安装至本地仓库simbest-maven-repo，执行命令如下：
	...
	mvn install:install-file -DgroupId=com.cloopen -DartifactId=CCP_REST_SMS_SDK_JAVA_NO_commons_codec -Dversion=2.6.3 -Dfile=E:\CCP_REST_SMS_SDK_JAVA_NO_commons_codec-2.6.3.jar -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=E:\01_Work\01_DevSpace\worksapce_github\simbest-maven-repo\repository -DcreateChecksum=true
